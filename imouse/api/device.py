...
class Device():
    ...
    def device_get(self, device_id: str = '') -> Optional[DeviceListResponse]:
        ...
        return parse_model(DeviceListResponse, ret) if isinstance(ret, dict) else None
    ...
    def device_group_get(self, group_id: str = '') -> Optional[GroupListResponse]:
        ...
        return parse_model(GroupListResponse, ret) if isinstance(ret, dict) else None
    ...
    def device_set_name(self, device_id, name: str) -> Optional[IdListResponse]:
        ...
        return parse_model(IdListResponse, ret) if isinstance(ret, dict) else None
    ...
    def device_sort_set(self, sort_index, sort_value: int) -> Optional[DeviceSortResponse]:
        ...
        return parse_model(DeviceSortResponse, ret) if isinstance(ret, dict) else None
