...
class Shortcut():
    ...
    def shortcut_album_get(self, device_id: str, album_name: str = "", num: int = 20,
                           outtime: int = 15) -> Optional[AlbumFileResponse]:
        ...
        return parse_model(AlbumFileResponse, ret) if isinstance(ret, dict) else None

    def shortcut_album_upload(self, device_id: str, album_name: str, files: List[str], is_zip: bool = False,
                              outtime: int = 30) -> Optional[AlbumFileResponse]:
    ...
    def shortcut_album_down(self, device_id: str, files: List[AlbumFileParams], is_zip: bool = False,
                            outtime: int = 30) -> Optional[CommonResponse]:
        ...
        return parse_model(CommonResponse, ret) if isinstance(ret, dict) else None

    def shortcut_album_del(self, device_id: str, files: List[AlbumFileParams], outtime: int = 30) -> Optional[AlbumFileResponse]:
    ...
    def shortcut_album_clear(self, device_id: str, album_name: str = '', outtime: int = 30) -> Optional[AlbumFileResponse]:
    ...
    def shortcut_file_get(self, device_id: str, path: str = "",
                          outtime: int = 15) -> Optional[PhoneFileResponse]:
        ...
        return parse_model(PhoneFileResponse, ret) if isinstance(ret, dict) else None

    def shortcut_file_upload(self, device_id: str, path: str, files: List[str], is_zip: bool = False,
                             outtime: int = 30) -> Optional[PhoneFileResponse]:
    ...
    def shortcut_clipboard_set(self, device_id: str, text: str, sleep: int = 0, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_clipboard_get(self, device_id: str, outtime: int = 10) -> Optional[ResultTextResponse]:
        ...
        return parse_model(ResultTextResponse, ret) if isinstance(ret, dict) else None

    def shortcut_exec_url(self, device_id: str, url: str, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_device(self, device_id: str, state: int, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_bril(self, device_id: str, state: float, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_torch(self, device_id: str, state: int, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_flight(self, device_id: str, state: int, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_cdpd(self, device_id: str, state: int, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_switch_wlan(self, device_id: str, state: int, outtime: int = 10) -> Optional[CommonResponse]:
    ...
    def shortcut_device_ip(self, device_id: str, outtime: int = 10) -> Optional[ResultTextResponse]:
